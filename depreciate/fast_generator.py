...
model = RNN_VAE(
    len(vocab), 32, h_dim, z_dim, c_dim,
    p_word_dropout=0.3, pretrained_embeddings=None, freeze_embeddings=False,
...
def train_vae(n_iter=20000, log_interval=1000):
    lr = 1e-3
    ...
    for it in range(n_iter):
        ...
        sentence = inputs['word_seq']  # (32, 17)

        recon_loss, kl_loss = model.forward(sentence)
